...
os.makedirs("Unit_Test",exist_ok=True) # Makes the Unit_Test directory if it does not exist already
queries = ["cat:cs.DS","cat:math.FA","cat:cs.OS","cat:math.NT"]

total_target = 25 # Total number of abstracts
...
with open("Unit_Test/raw_out_data.txt", "w", encoding="utf-8") as fh:
