...
path = "Unit_Test/test_summaries.txt" # Path to save the summaries

print("This is the training set!!")

# Generates the summaries from the training set
for abstract in train_set_abstracts:
    raw_output = generate_summary(model, tokenizer, abstract, temperature=0.4, top_p=0.7)
...
path = "Unit_Test/outside_test_summaries.txt" # Path to save the summaries
